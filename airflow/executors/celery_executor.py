...
def on_celery_import_modules(*args, **kwargs):
    ...
    Loading these for each task adds 0.3-0.5s _per task_ before the task can run. For long running tasks this
    doesn't matter, but for short tasks this starts to be a noticable impact
    """
